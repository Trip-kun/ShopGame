...
function Talkies.draw(scale)
    ...
    love.graphics.print(currentDialog.title, titleX, titleY, scale, scale)
    -- Message text
    love.graphics.setColor(currentDialog.messageColor)
    love.graphics.printf(currentMessage.visible, textX, textY, boxW - imgW - (4 * currentDialog.padding), nil, 0, scale, scale)
